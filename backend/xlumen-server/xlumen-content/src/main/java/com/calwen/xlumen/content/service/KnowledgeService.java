...
/**
 * 知识服务：CRUD + 草稿自动保存 + 回收站软删/恢复（决策 D16）。
...
public interface KnowledgeService {
    ...
    /**
     * 草稿自动保存：knowledgeId 为空则新建草稿；内容未变化跳过写库（幂等）。
     *
     * @param dto 保存入参
     * @return 知识视图（含最新版本号）
     */
