...
public class HotKnowledgeCacheServiceImpl implements HotKnowledgeCacheService {
    ...
    private static final String KNOWLEDGE_KEY = "xlumen:knowledge:%d:%d";
    ...
    @Override
    public KnowledgeDetailVO getKnowledge(Long workspaceId, Long knowledgeId, Supplier<KnowledgeDetailVO> loader) {
        String key = String.format(KNOWLEDGE_KEY, workspaceId, knowledgeId);
        try {
    ...
    public void evictAll() {
        String[] patterns = {"xlumen:knowledge:*", "xlumen:knowledge:list:*", "xlumen:categories:*", "xlumen:tags:*"};
        try {
