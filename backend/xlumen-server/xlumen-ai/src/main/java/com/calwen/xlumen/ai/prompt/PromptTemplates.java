 ...
 * IDEA-026（Prompt 后台动态管理）落点：后续场景配置化后此处作为默认值来源。
 *
 * @author calwen
 * @date 2026/8/25
 */
public final class PromptTemplates {
    ...
    /** 审校-事实核对（挂 knowledge.search 工具，F-0604）。 */
    ...
    /** QA 知识问答（F-0701，双轨合并后唯一路径，走知识库工具）。 */
