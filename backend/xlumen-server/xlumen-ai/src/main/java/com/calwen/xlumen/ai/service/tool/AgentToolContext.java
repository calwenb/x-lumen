...
/**
 * 工具运行业务上下文（IDEA-025 F-0708）：按 WorkspaceContext 身份 + resolveVisibleKbIds 过滤（决策 D13），
 * 访客 userId=null 自动收敛到公开库；模型参数中的 kbId 必须校验在可见集合内，越权返回错误信封而非执行。
 * 命名避开 Spring AI 的 {@link org.springframework.ai.chat.model.ToolContext}（OPT-2/D20 消除同名遮蔽）。
 *
 * @author calwen
 * @date 2026/8/24
 */
