// engagement 模块 API：知识互动--评论列表匿名可读，
...
/** 互动反应状态：LIKE=已赞 / DISLIKE=已踩 / NONE=已取消（toggle 后无反应）。 */
...
/** 点赞 toggle（需登录）：与点踩互斥，返回切换后的反应状态。 */
...
/** 评论点赞 toggle（需登录）：与点踩互斥，返回切换后的反应状态。 */
...
/** 评论点踩 toggle（需登录）：与点赞互斥，返回切换后的反应状态。 */
