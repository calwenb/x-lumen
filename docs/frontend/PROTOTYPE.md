...
> 注：原 V3 的 AI 功能已按决策 D18（2026/8/20）并入 V2（PRODUCT §5 阶段标记说明），尚未定原型页，实施时按对应模块既有页面模式补充（AI 对话 B00/D 系、AI 增值 B11 面板、管理后台 A 系）；V3 仅剩 B06 知识归档（F-0207）与无独立页面的 F-1305 全文搜索。
